...
%PATH_XJAL% -version:1.6+ -cp com.xj.anylogic.engine.jar;com.xj.anylogic.engine.nl.jar;model.jar;lib/OptQuest.jar;lib/mysql-connector-java-5.1.33-bin.jar;com.xj.anylogic.engine.sa.jar -Xmx64m supply_chain.Optimization %*
