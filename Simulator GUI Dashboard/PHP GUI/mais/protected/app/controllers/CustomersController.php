...
class CustomersController extends BaseController {
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','Customers.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('Customers.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('Customers.form',$this->data);
	...
	function getShow( $id = null)
	{
		...
		return View::make('Customers.view',$this->data);
