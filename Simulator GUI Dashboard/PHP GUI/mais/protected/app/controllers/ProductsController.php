...
class ProductsController extends BaseController {
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','Products.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('Products.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('Products.form',$this->data);
