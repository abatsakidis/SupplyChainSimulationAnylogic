...
class CategoriesController extends BaseController {
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','Categories.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('Categories.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('Categories.form',$this->data);
	...
	function getShow( $id = null)
	{
		...
		return View::make('Categories.view',$this->data);
