...
class SuppliersController extends BaseController {
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','Suppliers.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('Suppliers.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('Suppliers.form',$this->data);
	...
	function getShow( $id = null)
	{
		...
		return View::make('Suppliers.view',$this->data);
