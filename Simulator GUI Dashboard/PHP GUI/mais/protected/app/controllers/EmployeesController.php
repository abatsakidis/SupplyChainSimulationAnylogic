...
class EmployeesController extends BaseController {
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','Employees.index',$this->data);
	}		
	...
	{ 
		...
		return View::make('Employees.table',$this->data);
	...
	function getAdd( $id = null)
	{
		...
		$this->data['id'] = $id;
		return View::make('Employees.form',$this->data);
	...
	function getShow( $id = null)
	{
		...
		return View::make('Employees.view',$this->data);
