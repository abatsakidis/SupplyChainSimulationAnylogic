		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						...
						{{ SiteHelpers::activeLang('Κωδικός πελάτη', (isset($fields['CustomerID']['language'])? $fields['CustomerID']['language'] : array())) }}	
						</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>
						{{ SiteHelpers::activeLang('Όνομα υπευθύνου', (isset($fields['ContactName']['language'])? $fields['ContactName']['language'] : array())) }}	
						</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>
						{{ SiteHelpers::activeLang('Τίτλος υπευθύνου', (isset($fields['ContactTitle']['language'])? $fields['ContactTitle']['language'] : array())) }}	
						</td>
