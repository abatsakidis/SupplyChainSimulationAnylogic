	 ...
	 <div class="table-responsive">
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<td ><strong><?php echo $rows['field'];?></strong> <br />
				...
				<td >           
				  ...
				  <?php $lang = SiteHelpers::langOption();
				   ...
				   <span class="input-group-addon xlick bg-default btn-sm " ><?php echo ucwords($l['folder']);?></span>
				...
				<td>
				<label >
					<?php $alg = array('left','center','right');?>
					<select  name="align[<?php echo $id;?>]">
						<?php foreach($alg as $a) {?>
						<option value="<?php echo $a;?>" <?php if($rows['align'] == $a) echo 'selected="selected"';?>><?php echo ucwords($a);?></option>
						<?php } ?>
					</select>
				...
				<td >
				<a style="padding-bottom:5px;" class="  btn-primary btn-xs tips exp-formater" title="Format Column Field" href="javascript:void(0)" rel="format-<?php echo $id;?>" ><i class="fa fa-cogs"></i> More Option </a>
