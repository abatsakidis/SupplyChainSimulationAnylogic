{{--*/ usort($tableGrid, "SiteHelpers::_sort") /*--}}
  <div class="page-content row">
    ...
    <div class="toolbar-line ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('logs/add') }}" class="tips btn btn-xs btn-info"  title="{{ Lang::get('core.btn_create') }}">
			...
			<a href="{{ URL::to('logs/download') }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_download') }}">
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 <td>
					...
					<a href="{{ URL::to('logs/show/'.$id.'?md='.$masterdetail["filtermd"])}}"  class="tips btn btn-xs btn-default"  title="{{ Lang::get('core.btn_view') }}"><i class="icon-paragraph-justify"></i> </a>
					@endif
					@if($access['is_edit'] ==1)
					<a  href="{{ URL::to('logs/add/'.$id.'?md='.$masterdetail["filtermd"])}}"  class="tips btn btn-xs btn-success"  title="{{ Lang::get('core.btn_edit') }}"> <i class="icon-pencil4"></i></a>
					@endif
