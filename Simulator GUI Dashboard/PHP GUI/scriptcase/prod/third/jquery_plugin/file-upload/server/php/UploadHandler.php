...
//            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$_REQUEST['nivel'].'/',
//            'upload_url' => $this->get_full_url().'/files/'.$_REQUEST['nivel'].'/',
            'upload_dir' => $_POST['teste'].'/',
...
//                )
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            //$file_path = $this->get_upload_path(utf8_decode($file->name));
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
                $files[] = $this->handle_file_upload(
                    ...
                    //$file_name ? $this->utf8_strtr($file_name) : $this->utf8_strtr($upload['name'][$index]),
                    //$file_name ? utf8_decode($file_name) : utf8_decode($upload['name'][$index]),
