<?php  
  ...
  session_start() ;
  class pdfreport_tb_values_form_teste
  {
  function pdfreport_tb_values_teste()
  {
...
<html> 
<HEAD>
 <title>pdfreport_tb_values</title> 
...
<input type=submit value="pdfreport_tb_values"> 
</form> 
...
<?php
  ...
  $frm_teste = new pdfreport_tb_values_form_teste();
  $frm_teste->pdfreport_tb_values_teste();
?>
